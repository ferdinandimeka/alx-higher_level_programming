...
I* f no argument is given, set q=""
I* f the response body is properly JSON formatted and not empty, display the id and name like this: [<id>] <name>
Otherwise:
...
* You must use Basic Authentication with a [personal access token as password](https://docs.github.com/en/rest/overview/other-authentication-methods) to access to your information (only read:user permission is needed)
